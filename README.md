...
| ARMSX2 | PlayStation 2 emulator for ARM64 | `nightly-20260922` | iOS 17.0 |
...
| Kazumi | 基于自定义规则的番剧采集APP，支持流媒体在线观看，支持弹幕，支持实时超分辨率。 | `2.3.5` | iOS 13.0 |
...
| YouProEXTRA | YouTube mod with customizable tweaks | `21.38.2` | iOS 16.0 |
| ZhihuMinusMinus | 轻量、纯净的第三方知乎客户端 | `0.6.2` | iOS 15.1 |
