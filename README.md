...
| Apollo for Reddit - GLASS | Apollo-Reborn build with Liquid Glass patch | `3.7.0` | iOS 未声明 |
| ARMSX2 | PlayStation 2 emulator for ARM64 | `nightly-20260912` | iOS 17.0 |
...
| ZhihuMinusMinus | 轻量、纯净的第三方知乎客户端 | `0.6.0` | iOS 15.1 |
